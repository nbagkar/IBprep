export const technicalQuestionsData = [
  ...
  {
    question: "What if you’re making a career transition or you’re coming in as a more experienced hire?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "They order the inventory, but they have not manufactured or sold anything yet – what happens to the 3 statements?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "What would this look like under cash-based vs. accrual accounting?",
    category: "Accounting" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Can you walk me through an example of how they differ?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "How should you project Depreciation and Capital Expenditures?",
    category: "Accounting" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "It also has 10 options outstanding at an exercise price of $5 each – what is its fully diluted equity value?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "It also has 10 options outstanding at an exercise price of $15 each – what is its fully diluted equity value?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Could a company have a negative Enterprise Value?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "How do I calculate diluted shares outstanding?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Two companies have the exact same financial profiles and are bought by the same acquirer, but the EBITDA multiple for one transaction is twice the multiple of the other transaction – how could this happen?",
    category: "Valuation" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "If you were buying a vending machine business, would you pay a higher multiple for a business where you owned the machines and they depreciated normally, or one in which you leased the machines?",
    category: "Valuation" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "What’s the difference in how we select them?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "How do I select which report to use?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "What’s the problem with comparing these two valuations directly?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Cost of Equity tells us what kind of return an equity investor can expect for investing in a given company – but what about dividends?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Shouldn’t we factor dividend yield into the formula?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Do you count this as debt when calculating Levered Beta for the company?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "How would we change the DCF to account for the factory purchase, and what would our new Enterprise Value be?",
    category: "Valuation" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "One thing that’s not important?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "What types of sensitivities would you look at in a merger model?",
    category: "Financial Modeling" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "What variables would you look at?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "• Form of Consideration: Cash, Stock, Debt… • Transaction Structure: Stock, Asset, or 338(h)(10) • Treatment of Options: Assumed by the buyer?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "• Reps & Warranties: What must the buyer and seller claim is true about their respective businesses?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "• No-Shop / Go-Shop: Can the seller “shop” this offer around and try to get a better deal, or must it stay exclusive to this buyer?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "But let’s say I want to combine all 3 financial statements – how would I do this?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "What are reasonable leverage and coverage ratios?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Yes Cash / PIK Tenor: 3-5 years 4-6 years 4-8 years 7-10 years 8-10 years 8-12 years Amortization: None Straight Line Minimal Bullet Prepayment?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Yes No Investors: Conservative Banks HFs, Merchant Banks, Mezzanine Funds Seniority Senior Secured Senior Unsecured Senior Subordinated Equity Secured?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Yes Sometimes No Call Protection?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Call Protection: Is the company prohibited from “calling back” – paying off or redeeming – the security for a certain period?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "How would an asset write-up or write-down affect an LBO model?",
    category: "Financial Modeling" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "Can you also use Section 338(h)(10) election?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "How fast should the driver drive to travel the same 60 miles in the same time period, but at an average of 60 miles per hour?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "What is the greatest dollar value in coins you can have in your hands without being able to make change for a dollar?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
  ...
  {
    question: "How do you get exactly 4 liters of water?",
    category: "General" as const,
    difficulty: "Medium" as const,
    answer: "",
    notes: "",
...
// Total questions: 175
// Categories: General, Accounting, Financial Modeling, Valuation, M&A, Market Sizing, LBO
